defmodule Rumbl.VideoControllerTest do
  use RumblWeb.ConnCase, asyn: true
  ...
  describe "with logged-in user" do
    ...
    @tag login_as: "max"
    test "creates a user vid and redirects", %{conn: conn, user: user} do
    ...
    @tag login_as: "max"
    test "does not create vid, renders errors in invalid", %{conn: conn} do
